export let data = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        content:
          'Installer FontAwesome via npm et importer dans le fichier de styles global',
        priority: 3,
      },
      {
        id: 3,
        ...
        content:
          'Ajouter/supprimer des cards. Ajouter/supprimer/update des listes',
        priority: 1,
      },
      {
        id: 4,
        ...
        content:
          "Pour modifier l'apparence de la page en ajoutant des class CSS dynamiquement",
        priority: 2,
      },
      {
        id: 5,
      ...
      },
      {
        ...
        content:
          'Créer un component component sidebar qui affiche la liste des tâche par liste et par priorité',
        priority: 1,
      },
      {
        id: 7,
        ...
        content:
          "Créer un service et externaliser les données et les méthodes d'accès",
        priority: 1,
      },
    ],
  },
    ...
    cards: [
      {
        ...
        content:
          'Les components sont "étanches" et chacun possède son propres CSS. Comment Angular gère cela?',
        priority: 2,
      },
      {
        id: 9,
